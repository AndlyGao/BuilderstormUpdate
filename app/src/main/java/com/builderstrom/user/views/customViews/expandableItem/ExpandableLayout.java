package com.builderstrom.user.views.customViews.expandableItem;
...
import static com.builderstrom.user.views.customViews.expandableItem.ExpandableLayout.State.COLLAPSED;
import static com.builderstrom.user.views.customViews.expandableItem.ExpandableLayout.State.COLLAPSING;
import static com.builderstrom.user.views.customViews.expandableItem.ExpandableLayout.State.EXPANDED;
import static com.builderstrom.user.views.customViews.expandableItem.ExpandableLayout.State.EXPANDING;
