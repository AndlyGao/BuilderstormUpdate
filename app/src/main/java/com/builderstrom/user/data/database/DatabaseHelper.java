...
package com.builderstrom.user.data.database;
...
import com.builderstrom.user.data.database.databaseModels.DbCompanyDocuments;
import com.builderstrom.user.data.database.databaseModels.DbDigitalDocs;
import com.builderstrom.user.data.database.databaseModels.DbRFI;
import com.builderstrom.user.data.database.databaseModels.DbSnag;
...
import com.builderstrom.user.data.database.databaseModels.DbToDo;
import com.builderstrom.user.data.database.databaseModels.Diary;
...
import com.builderstrom.user.data.database.databaseModels.Drawings;
...
import com.builderstrom.user.data.database.databaseModels.ProjectDocs;
import com.builderstrom.user.data.database.databaseModels.ReportProblem;
import com.builderstrom.user.data.database.databaseModels.ShareDocs;
...
import com.builderstrom.user.data.database.databaseModels.ToDoCompleteStatus;
...
import com.builderstrom.user.data.retrofit.modals.SyncToDoModel;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static DatabaseHelper newInstance;

    public static DatabaseHelper getDatabaseInstance(Context context) {
        if (newInstance == null) {
            newInstance = new DatabaseHelper(context);
        }
        return newInstance;
    }
