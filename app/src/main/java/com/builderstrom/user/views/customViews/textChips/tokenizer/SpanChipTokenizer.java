package com.builderstrom.user.views.customViews.textChips.tokenizer;
...
import com.builderstrom.user.views.customViews.textChips.ChipConfiguration;
import com.builderstrom.user.views.customViews.textChips.chip.Chip;
import com.builderstrom.user.views.customViews.textChips.chip.ChipCreator;
...
public class SpanChipTokenizer<C extends Chip> implements ChipTokenizer {
    ...
    private Comparator<Pair<Integer, Integer>> mReverseTokenIndexesSorter = (lhs, rhs) -> rhs.first - lhs.first;
